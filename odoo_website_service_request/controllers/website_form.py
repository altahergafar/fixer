...
class servicerequestProduct(http.Controller):
    """    Controller for handling servicerequest products.
    """
...
class WebsiteFormInherit(WebsiteForm):
    ...
    def _handle_website_form(self, model_name, **kwargs):
        ...
        if model_name == 'service.request':
            tickets = request.env['service.request.stage'].sudo().search([])
            if tickets:
