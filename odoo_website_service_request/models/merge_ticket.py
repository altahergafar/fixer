...
class MergeTicket(models.Model):
    ...
    support_ticket_id = fields.Many2one('service.request',
    ...
    support_ticket_ids = fields.One2many('support.servicerequest',
                                         'support_ticket_id',
    ...
    def default_get(self, fields_list):
        ...
        selected_tickets = self.env['service.request'].browse(active_ids)
        ...
        servicerequest_team = selected_tickets.mapped('team_id')
